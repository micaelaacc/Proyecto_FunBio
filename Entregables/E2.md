...
2. WO2011021921A1 - Prótesis mecánica para antebrazo - 2011

La patente se relaciona con el campo de las prótesis humanas especialmente con el brazo. Esta invención provee un antebrazo mecánico que utiliza tecnología mioeléctrica para activar el funcionamiento del antebrazo y que gracias a los materiales por los que esta compuesto es un dispositivo ligero y que el paciente no presentará dificultades para portarlo. El antebrazo posee un motor que le permite a la muñeca y manos mecánicos de realizar movimientos de giros. Es un desarrollo innovador, ya que, une el antebrazo y la mano mediante dos placas de unión y ademñas, tambien se presentará el movimiento de abertura y cierre de los dedos. La activación del motor se dará a través de la estimulación mioeléctrica del paciente 

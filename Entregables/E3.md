...
### Beneficios
En vista a la calidad de vida del paciente, se refiere un beneficio suyo un brazo protésico con agarre de gancho y llave, ello para establecer valores predeterminados de la función original de un brazo, entre ellos establecer funcionalidades del brazo humano en el paciente como agarre de llave y gancho, permitiendo aliviando molestias causadas como dolor fantasma. A la vez se le instala un mouse inalámbrico para sus actividades laborales, que trae beneficios como los siguientes:
